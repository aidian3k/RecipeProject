...
create table recipe (id bigint not null auto_increment, cook_time integer, description varchar(255), difficulty varchar(255), directions longtext, image longblob, prep_time integer, servings integer, source longtext, url varchar(255), notes_id bigint, primary key (id)) engine=InnoDB;
...
create table unit_of_measure (id bigint not null auto_increment, description longtext, ingredient_id bigint, primary key (id)) engine=InnoDB;
